...
<x-layout :notifications="$notifications" :notificationscounts="$notifications_counts">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Watch And Earn/</span> Youtube
        </h4>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="plyr__video-embed" id="plyr-video-player">
                                <iframe src="{{ $video->url }}" allowfullscreen allowtransparency allow="autoplay"></iframe>
                            </div>
                        </div>
                        <style>
                            .plyr__controls {
                ...
                <script>
                    function message() {
                        ...
                        $(document).ready(function() {
                            ...
                            $.post("{{ route('ClaimingRewardYoutube') }}", {
                                video_id: video_id,
                            }, function(data) {
                                Swal.fire(
                                    'Good job!',
    ...
    @section('scripts')
        <script>
            const alertBoxupload = document.querySelector('.message-alert');
            if (alertBoxupload) {
                setTimeout(() => {
                    alertBoxupload.classList.toggle("animate__bounceOutUp", !alertBoxupload.classList.contains("animate__bounceOutUp"));
                }, 4000);
            }
        </script>
