                ...
                8764: function (t) {
                    (t.exports = (function () {
                        ...
                        const e = (t) => {
                            ...
                            p = (t) =>
                                d(t) ? t.toPromise() : Promise.resolve(t),
                            ...
                            B = () =>
                                h(".".concat(n.actions, " .").concat(n.deny)),
                            x = () => h(".".concat(n.loader)),
                            E = () =>
                                h(".".concat(n.actions, " .").concat(n.cancel)),
                            T = () => f(n.actions),
                            S = () => f(n.footer),
                            ...
                            _ = (t, e) => {
                                ...
                                for (let t = 0; t < n.length; t++) {
                                    const o = n[t];
                                    if (o instanceof HTMLElement && q(o, e))
                                        return o;
                                }
                            },
                            z = (t, e, n) => {
                            ...
                            et = (t) =>
                                new Promise((e) => {
                                    ...
                                    (tt.restoreFocusTimeout = setTimeout(() => {
                                        tt.previousActiveElement instanceof
                                        HTMLElement
                                ...
                                ((t, e) => {
                                    ...
                                    ((e, n) => {
                                        const i = t.innerParams.get(e),
                                            s = y();
                                        if (i && n.icon === i.icon)
                                            return Bt(s, n), void kt(s, n);
                                        if (n.icon || n.iconHtml) {
                                            if (
                                                n.icon &&
                                                -1 ===
                                                    Object.keys(o).indexOf(
                                                        n.icon
                                                    )
                                            )
                                                return (
                        ...
                        const Ht = () => P() && P().click(),
                            ...
                            Wt = (t) => {
                                ...
                                for (let t = 0; t < T().children.length; t++) {
                                    if (((s = s[i]), !s)) return;
                                    if (s instanceof HTMLButtonElement && $(s))
                                        break;
                                }
                        ...
                        const ne = (e) => {
                            ...
                            se = (t, e, n, o, i) => {
                                (tt.swalCloseEventFinishedCallback = Gt.bind(
                                    null,
                                    t,
                                    n,
                                    o,
                        ...
                        const le = {
                            ...
                            me = (t) =>
                                Object.prototype.hasOwnProperty.call(le, t),
                            ge = (t) => -1 !== ue.indexOf(t),
                            he = (t) => de[t],
                            fe = (t) => {
                                me(t) ||
                        ...
                        const Je = (t) => {
                            for (
                                ...
                                for (const t in $e) {
                                    ...
                                    if (n)
                                        return void $e[t].fire({ template: n });
                                }
                        };
                        var Qe = Object.freeze({
                            ...
                            enableLoading: Pe,
                            getTimerLeft: () =>
                                tt.timeout && tt.timeout.getTimerLeft(),
                            stopTimer: Ye,
                            resumeTimer: Ze,
                            toggleTimer: () => {
                                const t = tt.timeout;
                            ...
                            isTimerRunning: () =>
                                tt.timeout && tt.timeout.isRunning(),
                        ...
                        const tn = ["swal-title", "swal-html", "swal-footer"],
                            ...
                            dn = (t) => {
                                ...
                                const n = g();
                                e.removeEventListener(lt, dn),
                                    (n.style.overflowY = "auto");
                            },
                            pn = (t, e) => {
                                lt && Q(e)
                                    ? ((t.style.overflowY = "hidden"),
                                      e.addEventListener(lt, dn))
                        ...
                        class yn {
                            ...
                            _main(e) {
                                ...
                                ((t) => {
                                    ...
                                    for (const e in t)
                                        fe(e), t.toast && be(e), ye(e);
                                })(Object.assign({}, n, e)),
                                    tt.currentInstance &&
                                        (tt.currentInstance._destroy(),
                                        M() && Kt()),
                                ...
                                fn(o),
                                    Object.freeze(o),
                                    tt.timeout &&
                                        (tt.timeout.stop(), delete tt.timeout),
                                    clearTimeout(tt.restoreFocusTimeout);
                                const i = Cn(bn);
                                return (
                                    Ot(bn, o),
                                    t.innerParams.set(bn, o),
                                    wn(bn, i, o)
                                );
                            }
                            then(e) {
