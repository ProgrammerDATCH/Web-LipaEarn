(function (global, factory) {
    ...
    var s = (function (_t) {
        ...
        function s(t) {
            ...
            _this.invalidFormHandler = _this.onFormInvalid.bind(
                _assertThisInitialized(_this)
            );
            return _this;
        }
        _createClass(s, [
            {
                ...
                value: function install() {
                    this.core
                        ...
                        .registerPlugin(this.fieldStatusPluginName, new t());
                },
            },
            {
                key: "uninstall",
            ...
            },
            {
                ...
                value: function onFormInvalid() {
                    ...
                    var i = t.getStatuses();
                    var _s = Object.keys(this.core.getFields()).filter(
                        function (t) {
                    ...
                    if (_s.length > 0) {
                        ...
                        if (_i.length > 0) {
                            var _s3 = _i[0];
                            var e = { firstElement: _s3, field: _t2 };
