(function (global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : ((global =
          ...
          (global.FormValidation.plugins.Bootstrap5 = factory()));
})(this, function () {
    "use strict";
    ...
    var l = (function (_n) {
        ...
        function l(e) {
            ...
            _this.eleValidatedHandler = _this.handleElementValidated.bind(
        ...
        _createClass(l, [
            {
                ...
                value: function install() {
                    _get(_getPrototypeOf(l.prototype), "install", this).call(
                        this
                    );
                    this.core.on(
            ...
            },
            {
                ...
                value: function handleElementValidated(n) {
                    ...
                    if (
                        ("checkbox" === _l || "radio" === _l) &&
                        n.elements.length > 1 &&
                        t(n.element, "form-check-input")
                    ) {
                        var _l5 = n.element.parentElement;
                        if (
                            t(_l5, "form-check") &&
                            t(_l5, "form-check-inline")
                        ) {
                            e(_l5, {
                                "is-invalid": !n.valid,
                                "is-valid": n.valid,
            ...
            },
            {
                ...
                value: function onIconPlaced(n) {
                    ...
                    if (t(_l3, "input-group")) {
                        _l3.parentElement.insertBefore(
                            n.iconElement,
                            _l3.nextSibling
                        );
                        if (
                            n.element.nextElementSibling &&
                            t(n.element.nextElementSibling, "input-group-text")
                        ) {
                            e(n.iconElement, {
            ...
            },
            {
                ...
                value: function onMessagePlaced(n) {
                    ...
                    if (
                        ...
                        t(n.element, "form-check-input") &&
                        t(_l4, "form-check") &&
                        !t(_l4, "form-check-inline")
                    ) {
                        n.elements[
                            n.elements.length - 1
                        ].parentElement.appendChild(n.messageElement);
                    }
                },
            },
        ]);
