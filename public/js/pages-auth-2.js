"use strict";
const formAuthentication2 = document.querySelector("#formAuthentication-2");
document.addEventListener("DOMContentLoaded", function (e) {
    var t;
    formAuthentication2 &&
        FormValidation.formValidation(formAuthentication2, {
            fields: {
                first_name: {
                    validators: {
                ...
                password_confirmation: {
                    validators: {
                        ...
                        identical: {
                            compare: function () {
                                return formAuthentication2.querySelector(
                                    '[name="password"]'
                                ).value;
                            },
                            message:
